...
3. For images, call generate_image TWICE: once with size 'portrait_4_3' and once with size 'landscape_16_9'. Pass both URLs to send_email using image_urls. Never include words, text, or quotes in image prompts — text belongs in the email body only.
